...
- **Hosted daemon mode** — deploy authsome on an internal server and point multiple machines at it. Approved for VPN / private networks only; not yet hardened for public internet use.
