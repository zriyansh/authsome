...
OAuth2 providers. GitHub, Google, Linear, Slack, Notion, and many of the bundled providers, use a browser-based <Tooltip tip="Proof Key for Code Exchange. RFC 7636. Prevents authorization-code interception by binding the code to a random code verifier the client generated.">PKCE</Tooltip> flow by default. You authenticate once, and authsome takes over token refresh from there.
