...
GitHub, Google, Microsoft, and many others support it. Check `uvx authsome inspect <provider>` for `supports_device_code: true`. [Postiz](/integrations/oauth/postiz) is the only bundled provider that defaults to the device code flow.
