...
| Where to get a key | [https://dashboard.clearbit.com/api](https://dashboard.clearbit.com/api) |

## Get a key

Create an API key in the Clearbit dashboard at [https://dashboard.clearbit.com/api](https://dashboard.clearbit.com/api).
...
<ProxyInjection envVar="CLEARBIT_API_KEY" secretLabel="key" host="api.clearbit.com" />
...
key = ctx.auth.get_access_token("clearbit", connection="default")
```
